...
export default class App extends Component {
	...
	handleSearch = (input, field) => {
		const filteredList = this.state.originalMovies.filter((movie) => {
			const lowercased = movie[field].toLowerCase();
			return lowercased.includes(input.toLowerCase());
		});
	...
	render() {
		return (
			<div>
				...
				<Table filmsData={this.state.films} />
			</div>
		);
	}
}
